...
- **Mandatory Documentation Sync**: Every major feature addition, schema modification, API route update, or architectural change MUST be immediately synchronized with the authoritative project documentation (`docs/tech_spec.md`, `docs/features.md`, and `docs/master_spreadsheet_schema.md`). Every significant change completed is added as a completed task in the docs.
