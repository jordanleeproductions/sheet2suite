...
export let mockDatabase: WeddingData = {
  ...
  guests: [
    { guestId: 'G1', firstName: 'Sarah', lastName: 'Connor', partyGroup: 'Bride Family', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'Gluten Free', mealChoice: 'Filet Mignon', tableAssignment: 'Table 1 - Head Table', emailAddress: 'sarah.c@example.com', phoneNumber: '555-0199', mailingAddress: '123 Main St, LA' },
    { guestId: 'G2', firstName: 'John', lastName: 'Connor', partyGroup: 'Bride Family', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'None', mealChoice: 'Filet Mignon', tableAssignment: 'Table 1 - Head Table', emailAddress: 'john.c@example.com', phoneNumber: '555-0120', mailingAddress: '123 Main St, LA' },
    { guestId: 'G3', firstName: 'Marcus', lastName: 'Wright', partyGroup: 'Groom Friends', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'Vegan', mealChoice: 'Vegan Risotto', tableAssignment: 'Table 2 - Family VIP', emailAddress: 'marcus@example.com', phoneNumber: '555-0143', mailingAddress: '456 Oak Rd, Chicago' },
    { guestId: 'G4', firstName: 'Kate', lastName: 'Brewster', partyGroup: 'Groom Family', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'None', mealChoice: 'Pan-Seared Salmon', tableAssignment: 'Table 2 - Family VIP', emailAddress: 'kate@example.com', phoneNumber: '555-0187', mailingAddress: '789 Pine Ave, Seattle' },
    { guestId: 'G5', firstName: 'Tim', lastName: 'Brewster', partyGroup: 'Groom Family', ageCategory: 'Child', rsvpStatus: 'Attending', dietaryRestrictions: 'Nut Allergy', mealChoice: 'Kids Chicken Tenders', tableAssignment: 'Unassigned', emailAddress: 'tim@example.com', phoneNumber: '555-0188', mailingAddress: '789 Pine Ave, Seattle' },
    { guestId: 'G6', firstName: 'Danny', lastName: 'Dyson', partyGroup: 'Bride Friends', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'None', mealChoice: 'Filet Mignon', tableAssignment: 'Unassigned', emailAddress: 'danny@example.com', phoneNumber: '555-0155', mailingAddress: '321 Elm Blvd, Austin' },
    { guestId: 'G7', firstName: 'Miles', lastName: 'Dyson', partyGroup: 'Bride Friends', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'Dairy Free', mealChoice: 'Pan-Seared Salmon', tableAssignment: 'Unassigned', emailAddress: 'miles@example.com', phoneNumber: '555-0154', mailingAddress: '321 Elm Blvd, Austin' },
    { guestId: 'G8', firstName: 'Elena', lastName: 'Rostova', partyGroup: 'Bride Family', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'Vegetarian', mealChoice: 'Vegan Risotto', tableAssignment: 'Unassigned', emailAddress: 'elena@example.com', phoneNumber: '555-0112', mailingAddress: '55 Maple St, Boston' },
    { guestId: 'G9', firstName: 'Viktor', lastName: 'Rostov', partyGroup: 'Bride Family', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'None', mealChoice: 'Filet Mignon', tableAssignment: 'Unassigned', emailAddress: 'viktor@example.com', phoneNumber: '555-0113', mailingAddress: '55 Maple St, Boston' },
    { guestId: 'G10', firstName: 'James', lastName: 'Vance', partyGroup: 'Groom Friends', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'None', mealChoice: 'Pan-Seared Salmon', tableAssignment: 'Unassigned', emailAddress: 'james@example.com', phoneNumber: '555-0210', mailingAddress: '88 River Rd, Denver' },
    { guestId: 'G11', firstName: 'Chloe', lastName: 'Vance', partyGroup: 'Groom Friends', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'Gluten Free', mealChoice: 'Pan-Seared Salmon', tableAssignment: 'Unassigned', emailAddress: 'chloe@example.com', phoneNumber: '555-0211', mailingAddress: '88 River Rd, Denver' },
    { guestId: 'G12', firstName: 'Liam', lastName: 'Gallagher', partyGroup: 'Bridal Party', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'None', mealChoice: 'Filet Mignon', tableAssignment: 'Unassigned', emailAddress: 'liam@example.com', phoneNumber: '555-0301', mailingAddress: '14 High St, London' },
    { guestId: 'G13', firstName: 'Maya', lastName: 'Lin', partyGroup: 'Bridal Party', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'Shellfish Allergy', mealChoice: 'Filet Mignon', tableAssignment: 'Unassigned', emailAddress: 'maya@example.com', phoneNumber: '555-0302', mailingAddress: '900 Broadway, NY' },
    { guestId: 'G14', firstName: 'Noah', lastName: 'Centineo', partyGroup: 'Groom Friends', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'None', mealChoice: 'Pan-Seared Salmon', tableAssignment: 'Unassigned', emailAddress: 'noah@example.com', phoneNumber: '555-0411', mailingAddress: '12 Palm Way, Miami' },
    { guestId: 'G15', firstName: 'Sophia', lastName: 'Turner', partyGroup: 'Bride Friends', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'Vegan', mealChoice: 'Vegan Risotto', tableAssignment: 'Unassigned', emailAddress: 'sophia@example.com', phoneNumber: '555-0520', mailingAddress: '33 Sunset Blvd, LA' },
    { guestId: 'G16', firstName: 'David', lastName: 'Kim', partyGroup: 'Groom Family', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'None', mealChoice: 'Filet Mignon', tableAssignment: 'Unassigned', emailAddress: 'david.k@example.com', phoneNumber: '555-0612', mailingAddress: '77 Ocean Ave, SF' },
    { guestId: 'G17', firstName: 'Hannah', lastName: 'Kim', partyGroup: 'Groom Family', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'Kosher', mealChoice: 'Vegan Risotto', tableAssignment: 'Unassigned', emailAddress: 'hannah.k@example.com', phoneNumber: '555-0613', mailingAddress: '77 Ocean Ave, SF' },
    { guestId: 'G18', firstName: 'Oliver', lastName: 'Smith', partyGroup: 'Bride Friends', ageCategory: 'Child', rsvpStatus: 'Attending', dietaryRestrictions: 'Nut Allergy', mealChoice: 'Kids Chicken Tenders', tableAssignment: 'Unassigned', emailAddress: 'oliver@example.com', phoneNumber: '555-0714', mailingAddress: '40 Park Row, NY' },
    { guestId: 'G19', firstName: 'Isabella', lastName: 'Rossi', partyGroup: 'Groom Friends', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'Pescetarian', mealChoice: 'Pan-Seared Salmon', tableAssignment: 'Unassigned', emailAddress: 'isabella@example.com', phoneNumber: '555-0815', mailingAddress: '20 Roma St, Chicago' },
    { guestId: 'G20', firstName: 'Lucas', lastName: 'Silva', partyGroup: 'Bride Family', ageCategory: 'Adult', rsvpStatus: 'Attending', dietaryRestrictions: 'None', mealChoice: 'Filet Mignon', tableAssignment: 'Unassigned', emailAddress: 'lucas@example.com', phoneNumber: '555-0916', mailingAddress: '15 Rio Way, Orlando' }
  ],
  budget: [
