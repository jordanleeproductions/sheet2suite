...
- [x] Advanced Settings & Configuration Portal (`AdvancedSettingsModal` with Wedding Metadata Editor, Visual & UX Theme / 12h-24h Time Format controls, Drive Inspector, Module Toggles, and Feedback/Bug Submitter).
